...
| PF-UIV2-IMG-01 | 待補 | 三張最新定案圖 1：**repository／工作區未找到，待提供永久連結或歸檔路徑** | 待圖面確認 | 待圖面確認 | BLOCKED | 未鎖定來源，不得開始對應畫面實作 |
| PF-UIV2-IMG-02 | 待補 | 三張最新定案圖 2：**repository／工作區未找到，待提供永久連結或歸檔路徑** | 待圖面確認 | 待圖面確認 | BLOCKED | 未鎖定來源，不得開始對應畫面實作 |
| PF-UIV2-IMG-03 | 待補 | 三張最新定案圖 3：**repository／工作區未找到，待提供永久連結或歸檔路徑** | 待圖面確認 | 待圖面確認 | BLOCKED | 未鎖定來源，不得開始對應畫面實作 |
