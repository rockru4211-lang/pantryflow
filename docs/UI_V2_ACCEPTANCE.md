...
| 原盤點表自動識別修復 | 匯入卡顯示已對應、將新建、重複已合併、待確認，並逐項說明推定結果 | 不要求商品碼；「編號」只作原表順序；依品名產生穩定識別碼；多工作表一起辨識；`期末數量`優先作回填欄；同區同品重複列合併，識別衝突阻擋發布 | PF-PILOT-COUNT-RECEIVING-FINAL-20260827／PF-PILOT-FUNCTIONAL-REPAIR-20260827 | `fix/count-import-recognition-20260831` 開發中；Node 77／77；未合併、未部署 |
