...
export type SupplierProduct={id:string;name:string;specification:string|null;base_unit:string;current_supplier_id:string|null;is_active:boolean};
...
export type SupplierPriceItem={key:string;productId:string|null;name:string;specification:string;unit:string;history:SupplierReceiptLine[];latest:number|null;previous:number|null;change:number|null;percent:number|null;pending:number;ambiguous:boolean};
