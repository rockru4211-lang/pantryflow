...
function employeeHome(){return `<main class="home-page employee-home count-first-home" data-home-kind="employee">${countFirstAction('STAFF')}<p class="count-first-principle">不看歷史數字、不算差異；現場只負責把實際數量輸入完成。</p></main>`}
function managerHome(){return `<main class="home-page manager-home count-first-home" data-home-kind="manager">${countFirstAction('ADMIN')}<p class="count-first-principle">先把盤點跑順。進貨、廢棄與效期功能暫時不放進主要流程。</p></main>`}
