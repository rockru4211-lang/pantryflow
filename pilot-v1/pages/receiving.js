...
const fieldLabels={subtotal_ex_tax:'未稅小計',tax:'稅額',total_inc_tax:'含稅總額',supplier_name:'供應商',document_number:'貨單號碼',invoice_number:'貨單號碼',receipt_date:'到貨日期',product_name:'品項',quantity:'數量',unit:'單位',unit_price_ex_tax:'未稅單價',line_total_inc_tax:'含稅金額'};
