...
[
  ...
  [['expiry-inbound', 'expiry-edge', 'expiry-inspection', 'expiry-watchlist', 'expiry-alerts', 'expiry-suggest', 'expiry-inspection-record', 'expiry-issue', 'expiry-expired', 'expiry-discard', 'expiry-discard-work', 'expiry-discard-cold', 'expiry-discard-sauce', 'expiry-discard-complete', 'expiry-discard-complete-work', 'expiry-discard-complete-cold', 'expiry-discard-complete-sauce', 'expiry-zone-cold', 'expiry-zone-work', 'expiry-zone-sauce', 'expiry-zone-freezer', 'expiry-lot-cream', 'expiry-lot-beef', 'expiry-lot-ham', 'expiry-result-inspected', 'expiry-result-normal', 'expiry-result-label', 'expiry-quantity-reason', 'expiry-result-used', 'expiry-result-waste', 'expiry-result-waste-chain', 'expiry-result-quantity', 'expiry-erp-waste-complete'], ['STAFF', 'SUPERVISOR']],
