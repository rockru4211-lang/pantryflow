...
[
  ...
  [['expiry-risk-detail-work', 'expiry-risk-detail-cold', 'expiry-risk-detail-dry'], ['STAFF', 'SUPERVISOR', 'LOGISTICS']],
  [['expiry-risk-report-label-work', 'expiry-risk-report-label-cold', 'expiry-risk-report-label-dry', 'expiry-risk-report-other-work', 'expiry-risk-report-other-cold', 'expiry-risk-report-other-dry'], ['STAFF', 'SUPERVISOR']],
  [['expiry-inbound', 'expiry-edge', 'expiry-inspection', 'expiry-watchlist', 'expiry-alerts', 'expiry-suggest', 'expiry-inspection-record', 'expiry-issue', 'expiry-expired', 'expiry-discard', 'expiry-discard-work', 'expiry-discard-cold', 'expiry-discard-sauce', 'expiry-discard-overdue-work', 'expiry-discard-overdue-cold', 'expiry-discard-overdue-sauce', 'expiry-discard-complete', 'expiry-discard-complete-work', 'expiry-discard-complete-cold', 'expiry-discard-complete-sauce', 'expiry-discard-complete-overdue-work', 'expiry-discard-complete-overdue-cold', 'expiry-discard-complete-overdue-sauce', 'expiry-used-confirm', 'expiry-used-confirm-work', 'expiry-used-confirm-cold', 'expiry-zone-cold', 'expiry-zone-work', 'expiry-zone-sauce', 'expiry-zone-freezer', 'expiry-lot-cream', 'expiry-lot-beef', 'expiry-lot-ham', 'expiry-result-inspected', 'expiry-result-normal', 'expiry-result-label', 'expiry-quantity-reason', 'expiry-result-used', 'expiry-result-used-work', 'expiry-result-used-cold', 'expiry-result-waste', 'expiry-result-waste-chain', 'expiry-result-quantity'], ['STAFF', 'SUPERVISOR']],
