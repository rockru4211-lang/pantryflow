...
[
  ...
  [['expiry-zone-cold', 'expiry-zone-work', 'expiry-zone-freezer', 'expiry-lot-cream', 'expiry-lot-beef', 'expiry-lot-ham', 'expiry-result-normal', 'expiry-result-label', 'expiry-quantity-reason', 'expiry-result-used', 'expiry-result-waste', 'expiry-result-waste-chain', 'expiry-result-quantity', 'expiry-erp-waste-complete'], ['STAFF', 'SUPERVISOR']],
