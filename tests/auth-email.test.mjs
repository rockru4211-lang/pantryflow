...
const vite = await createServer({ configFile: false, appType: 'custom', resolve:{alias:{'@':fileURLToPath(new URL('..',import.meta.url))}},cacheDir: 'node_modules/.vite/email-tests', server: { middlewareMode: true } });
after(() => vite.close());
