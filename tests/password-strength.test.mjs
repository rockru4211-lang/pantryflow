...
test('common, numeric and repeating passwords remain weak despite mixed characters or length',()=>{
 for(const value of ['Password123!','P@ssw0rd2026!','welcome12345','1111111111111111','1234567890123456','Ab1!Ab1!Ab1!','short'])assert.equal(assessPassword(value).level,'弱',value);
});
